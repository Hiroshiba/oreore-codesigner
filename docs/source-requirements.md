...
中央は出力先、`forceCodeSigning`、generic publish URL だけを CLI で上書きします。
...
macOS は ZIP、blockmap、更新 metadata を、Windows は通常 NSIS の installer、blockmap、更新 metadata と NSIS Web の installer、7z package を生成できなければなりません。
